...
const BookEdit = (props) =>
{
    ...
    const onFormSubmit = (e) => {
        ...
        const category = formData.category !== "DRAMA" ? formData.category : props.book.category.id;
        const author = formData.author !== 460 ? formData.author : props.book.author.id;
        const availableCopies = formData.availableCopies !== 1 ? formData.availableCopies : props.book.availableCopies;

        console.log("Author ID:", author); // Add this line to log the author id
